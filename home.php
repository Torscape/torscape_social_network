...
<head>
    <title>Home | <?echo lang('site_title')?></title>
    <meta charset="UTF-8">
...
<p class="homeLinks_title"><?php echo lang('recent_stars_from'); ?></p>
<?php
$mYiD = $_SESSION['id'];
...
?>
<a href="./u/<?php echo $_SESSION['Username']; ?>&ut=stars"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/1f4ab.png" /> <?php echo lang('see_all_stars'); ?></p></a>
...
<a href="page/feedback"><p class="<?php echo lang('HLP_b'); ?>"><img src="imgs/main_icons/1f4e4.png" /> <?php echo lang('Report_A_Problem'); ?></p></a>
    </div>
        </div>
    </div>
<!--======================[ end Center col1 ]=============================-->
