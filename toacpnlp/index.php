...
$genderM_sql = "SELECT gender FROM signup WHERE gender='Male'";
$genderM = $conn->prepare($genderM_sql);
$genderM->execute();
...
$genderO_sql = "SELECT gender FROM signup WHERE gender='Other'";
$genderO = $conn->prepare($genderO_sql);
$genderO->execute();
$genderO_num_rows = $genderO->rowCount();

$supportB_sql = "SELECT * FROM supportbox WHERE status=0";
$supportB = $conn->prepare($supportB_sql);
$supportB->execute();
$supportB_num_rows = $supportB->rowCount();
...
$genderO = thousandsCurrencyFormat($genderO_num_rows);
$supportB = thousandsCurrencyFormat($supportB_num_rows);
...
<head>
    <title><? echo lang('dashboard'); ?> | <?php echo lang('site_title')?></title>
    <meta charset="UTF-8">
...
<div class="dashboard_box" style="text-align: <? echo lang('textAlign'); ?>">
    ...
    <div id="General">
        <div id="1row" style="display: flex;">
            ...
            <div class="details" style="background: #DB7093;">
            <span style='<? echo lang('float2'); ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-female"></span>
               <p><h3><?php echo $genderF; ?></h3> <? echo lang('females'); ?></p>
            </div>
            <div class="details" style="background: #9C59D1;">
            <span style='<? echo lang('float2'); ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-user"></span>
               <p><h3><?php echo $genderO; ?></h3> <? echo lang('other'); ?></p>
            </div>
        </div>
        <div id="row2" style="display: flex;">
            ...
            <span style='<? echo lang('float2'); ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-info-circle"></span>
        ...
        <div id="row4" style="display: flex;">
            ...
            <div class="details" style="background: #63ab66;">
            <span style='<? echo lang('float2'); ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-sticky-note-o"></span>
               <p><h3><?php echo $notes; ?></h3> <? echo lang('notes'); ?></p>
            </div>
            <div class="details" style="background: #D4A172;">
            <span style='<? echo lang('float2'); ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-ticket"></span>
               <p><h3><?php echo $supportB; ?></h3> <? echo lang('supportTickets'); ?></p>
            </div>
        </div>
        <div id="row5" style="display: flex;">
            ...
            <div class="details" style="background: #2196f3;">
            <span style='<? echo lang('float2'); ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-gavel"></span>
