...
<div class="dashboard_box" style="text-align: <? echo lang('textAlign'); ?>">
    ...
    <!--///////////////User Actions/////////////////////-->
    <p class="dashboard_path"><a href="index?adb=General"><? echo lang('dashboard'); ?></a> / <a href="index?adb=Support_box"><? echo lang('supportBox'); ?></a> / <? echo lang('reply'); ?></p>
    <br>
   <?php
        $n=0;
        ...
        <table class="sbox_r_table">
            ...
            <tr>
                <td></td>
                <td><input type="submit" class="btn_blue" name="submitR" value="<? echo lang('reply'); ?>" /></td>
            </tr>
            </form>
        </table>
        <?php } ?>
