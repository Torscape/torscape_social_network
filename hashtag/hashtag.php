...
<head>
    <title><?php echo "Hashtag - ".$_GET['tag'];if($_GET['tag'] == 'search'){echo "Hashtag";} ?> | <?php echo lang('site_title')?></title>
    <meta charset="UTF-8">
    <meta name="keywords" content="hashtag,social network,social media,meet,free platform">
