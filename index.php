...
<head>
    ...
    <title><? echo lang('welcome').' | '. lang('site_title'); ?></title>
    <meta charset="UTF-8">
    <meta name="keywords" content="homepage,main,login,social network,social media,meet,free platform,torscape">
    ...
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index" class="login_signup_navbarLinks"><? echo lang('site_title')?></a>
                <a href="#" class="login_signup_navbarLinks"><? echo lang('help'); ?></a>
                <a href="#" class="login_signup_navbarLinks"><? echo lang('terms'); ?></a>
                <a href="javascript:void(0);" onclick="alert('More Info Coming Soon!')" class="login_signup_navbarLinks"><? echo lang('privacyPolicy'); ?></a>
        ...
        <h3 align="center"><? echo lang('welcome_to'); ?> Torscape</h3>
        <p align="center" style="color: #999; margin-bottom: 25px;"><? echo lang('main_string'); ?>.</p>
            <div style="display: flex;">
                ...
                <div style="width: 100%;text-align: center;">
                    <img src="imgs/main_icons/pc_main.png" alt="<?php echo lang('site_title')?>" style="width: 300px;" />
                </div>
            </div>
        </div>
