...
<head>
    <title><? echo lang('messages'); ?> | <?php echo lang('site_title')?></title>
    <meta charset="UTF-8">
    ...
    <div style="text-align: <? echo lang('textAlign'); ?>">
    	<div class="messages">
    		...
    		<div class="mCol2_title" data-user="0">
    			<? echo lang('messages'); ?> - <b style="color: #CC3300;">WARNING:</b> Messages are currently stored <b>unencrypted</b>. End to End Encryption Coming Soon
    		</div>
    		...
    		<div class="m_SendField_box">
    			<div class="m_SendField">
    				<textarea dir="auto" maxlength="1538" id="mSendField" placeholder="<? echo lang('write_a_message').' '.lang('newLine_Shift_enter').' Shift+Enter'; ?>"></textarea><span style="<? echo lang('float2'); ?>:0px;<? echo lang('float'); ?>:auto;" class="fa fa-smile-o m_SendField_span" onclick="mEmojiBtn()"></span>
