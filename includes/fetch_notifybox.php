...
$notify_sql = "SELECT * FROM notifications WHERE for_id =:myId ORDER BY time DESC LIMIT :load,6";
...
case 'mention':
	...
	case 'c_mention':
		...
		<p style='font-size:13px;'><b>$fullname</b> ".lang('c_mentionNotify_str')." <span style='color: #999;'></span>
		<span style='font-size: small;'></span><br>
		<img src='".$path."imgs/main_icons/1f4e2.png' style='width:14px;height:14px;' /> <span style='font-size:11px;'>$notify_time</span></span> 
		</p>
		</div>
