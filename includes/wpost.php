...
$apos = '/(&#39;)+/';
$p_content = preg_replace($apos, '\'', $p_content);
...
$mentions_url = '/((?:\@)([a-zA-Z0-9_%]*))/';
preg_match_all($mentions_url, $p_content, $matches);
...
for($i = 0; $i < $matchNum; $i++){
    ...
    while ($getuser_row = $getuser->fetch(PDO::FETCH_ASSOC)) {
        ...
        if(!($s_id == $for_id)){
            ...
            $sendNotification->bindParam(':notifyTypeId',$post_id,PDO::PARAM_INT);
