...
while ($comments_fetch = $show_comments->fetch(PDO::FETCH_ASSOC)) {
    ...
    if ($query_fetch_verify2 == "1"){
        $verifypage_var = "<span style='color: #03A9F4;' title='Verified Page' class='fa fa-check-circle'></span>";
        }else{
        $verifypage_var = "";
    }
    ...
    $comm_body = preg_replace($mention_url, "<a href='".$check_path."u/$2' title='@$2'>@$2</a>", $comm_body);
    $comm_body = nl2br($comm_body);
        ...
        <li><a href='javascript:void(0)' onclick=\"deleteComment('$id_4comm', '$post_id_4comm')\"><span class='fa fa-trash-o'></span> ".lang('comm_delete')."</a></li>";
        }elseif($_SESSION['admin'] > 0){
            echo "
            <li><a href='javascript:void(0)' onclick=\"fcomment('$post_id_4comm', '@$query_fetch_username2 ')\"><span class='fa fa-reply'></span> ".lang('reply')."</a></li>
            <li class='divider'></li> 
            <li><a href='javascript:void(0)' onclick=\"editComment('$id_4comm')\"><span class='fa fa-pencil-square-o'></span> ".lang('comm_edit')."</a></li>
            <li><a href='javascript:void(0)' onclick=\"deleteComment('$id_4comm', '$post_id_4comm')\"><span class='fa fa-trash-o'></span> ".lang('comm_delete')."</a></li>
            <li class='divider'></li>
