...
<head>
    <title><? echo lang('create_new_account'); ?> | <?php echo lang('site_title')?></title>
    <meta charset="UTF-8">
    <meta name="keywords" content="signup,social network,social media,meet,free platform">
    ...
    <div class="login_signup_navbar">
        <a href="index" class="login_signup_navbarLinks"><?php echo lang('site_title')?></a>
        ...
        <!--<a href="/forums" class="login_signup_navbarLinks">Forums</a>-->
    ...
    <div align="center">
        ...
        <!--============[ sign up sec ]============-->
            ...
            <p><input type="text" name="signup_fullname" class="login_signup_textfield" id="fn" placeholder="<? echo lang('displayname'); ?>"/></p>
            ...
            <select class="login_signup_textfield" name="gender" id="gr">
              ...
              <option><? echo lang('other'); ?></option>
            </select>
            </p>
            <p style="font-size: 11px;color: #5d5d5d;margin: 8px 0px; ">
                <? echo lang('by_clicking_signup_str'); ?> <a href="javascript:void(0);"><? echo lang('terms'); ?></a> <? echo lang('and'); ?> <a href="javascript:void(0);"><? echo lang('privacyPolicy'); ?></a>.</p>
        ...
        <div style="background: #fff; border-radius: 3px; width: 420px; padding: 15px; margin: 15px;color: #7b7b7b;" align="center">
            <? echo lang('already_have_an_account'); ?> <a href="login"><? echo lang('login_now'); ?></a>.<hr style="margin: 8px;">
                <a href="?lang=english">English</a> &bull; Other languages coming soon
        </div>
    </div>
...
// var emailAdd = document.getElementById("em").value; Add to data: 'em':emailAdd
...
data:{'req':'signup_code','fn':fullname,'un':username,'pd':password,'cpd':cpassword,'gr':gender, 'tz':timezone},
beforeSend:function(){
