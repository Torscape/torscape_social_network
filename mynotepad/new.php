...
<head>
    <title>Create new note | <?php echo lang('site_title')?></title>
    <meta charset="UTF-8">
...
<!--=============================[ Container ]=====================================-->
        <div align="center" style="margin-top: 65px;">
            ...
            <h3 style="margin-top: 0;margin-bottom: 0;"><?php echo lang('new_note'); ?></h3><span style="color: #CC3300;">WARNING: </span>Notes are currently stored <b>unencrypted</b>. Encryption coming soon!
