...
<head>
    <title><?php echo lang('my_notepad');?> | <?php echo lang('site_title')?></title>
    <meta charset="UTF-8">
...
<!--=============================[ Container ]=====================================-->
        <div align="center" style="margin-top: 65px;">
            <div class="white_div" style="text-align: <?php echo lang('textAlign'); ?>;">
                <p><span class="fa fa-lock"></span> <?php echo lang('my_notepad');?> - <span style="color: #CC3300;">WARNING: </span>Notes are currently stored <b>unencrypted</b>. Encryption coming soon! <a href="new" class="green_flat_btn" style="float: <?php echo lang('float2'); ?>;"><?php echo lang('new_note');?></a>
                <br><label style="font-weight: normal;color: rgba(0, 0, 0, 0.31);font-size: small;"><?php echo lang('mynotepad_main_title');?></label>
            </p>
        <?php
$s_id = $_SESSION['id'];
